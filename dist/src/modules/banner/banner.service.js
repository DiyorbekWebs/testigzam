...
let BannerService = exports.BannerService = class BannerService {
    ...
    async getAll(options) {
        return (0, nestjs_typeorm_paginate_1.paginate)(this.bannerRepository, options, {});
    }
    async getOne(id) {
    ...
    async getLeftBanner(options) {
        return (0, nestjs_typeorm_paginate_1.paginate)(this.bannerRepository, options, {
            where: {
                type: enum_1.BannerTypeEnum.LEFT
            }
        });
    }
    async getRightBanner(options) {
        return (0, nestjs_typeorm_paginate_1.paginate)(this.bannerRepository, options, {
            where: {
                type: enum_1.BannerTypeEnum.RIGHT
            }
        });
    }
    async deleteOne(id) {
...
exports.BannerService = BannerService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(banner_entity_1.Banner)),
