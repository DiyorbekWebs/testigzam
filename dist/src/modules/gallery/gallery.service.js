...
let GalleryService = exports.GalleryService = class GalleryService {
    ...
    async getAll(options, where) {
        return (0, nestjs_typeorm_paginate_1.paginate)(this.galleryRepository, options, {});
    }
    async getOne(id) {
    ...
    async getPhotoGallery(options) {
        return (0, nestjs_typeorm_paginate_1.paginate)(this.galleryRepository, options, {
            where: {
                type: enum_1.GalleryTypeEnum.PHOTO
            }
        });
    }
    async getVideoGallery(options) {
        return (0, nestjs_typeorm_paginate_1.paginate)(this.galleryRepository, options, {
            where: {
                type: enum_1.GalleryTypeEnum.VIDEO
            }
        });
    }
    async deleteOne(id) {
...
exports.GalleryService = GalleryService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(gallery_entity_1.Gallery)),
